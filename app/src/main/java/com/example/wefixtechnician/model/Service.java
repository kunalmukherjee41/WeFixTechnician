...
public class Service implements Serializable {
    ...
    public Service(int tbl_services_id, int cat_ref_id, String tbl_services_name, String tbl_services_des, int tbl_services_charge, double tblDelearServicesCharge, String status) {
